...
import { C, uid, today, Ic, Modal, Inp, Btn, Badge, Card, Row } from '../lib/ui.jsx'
...
export default function EnrollmentTab({data,setData,toast}) {
  ...
  return (
    <div>
      ...
      <Card accent={C.pink}>
        {/* FIXED: Replaced undefined STitle with a properly styled div */}
        <div style={{fontSize: 16, fontWeight: 800, color: C.dark, display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8}}>
          <Ic n="link" size={15} color={C.pink}/> Student Enrollment Link
        </div>
      ...
      {reqs.map(req=>{
        {/* FIXED: Added fallback empty arrays to prevent crashes if data is missing during initial load */}
