 ...
 * Matches the app's color palette and Nunito font.
 *
 * Route: /
 */
...
/* ── Brand constants (mirrors AppDashboard) ── */
const C = {
    ...
    <div>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '12px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <nav style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
            {navLinks.map(l => (
              <a key={l.href} href={l.href} style={{ padding: '6px 12px', borderRadius: 8, fontSize: 13, fontWeight: 600, color: C.grey, textDecoration: 'none', transition: 'all .15s' }}
                onMouseEnter={e => { e.target.style.color = C.pink; e.target.style.background = C.pinkPale; }}
                onMouseLeave={e => { e.target.style.color = C.grey; e.target.style.background = 'transparent'; }}>
                {l.label}
              </a>
            ))}
        ...
        {menuOpen && (
          <div style={{ background: C.white, borderTop: `1px solid ${C.pinkPale}`, padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: 4 }}>
            ...
            <a href={ENROLL_URL} style={{ padding: '12px 14px', borderRadius: 12, fontSize: 14, fontWeight: 800, background: `linear-gradient(135deg, ${C.pink}, ${C.pinkD})`, color: '#fff', textDecoration: 'none', textAlign: 'center', marginTop: 6 }}>
              🌸 Enroll Now
            </a>
          </div>
        )}
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', maxWidth: 600, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.9)', lineHeight: 1.7, marginBottom: 8 }}>
            Online courses in <strong>Mehndi · Makeup · ArtWork</strong>
          </p>
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.8)', lineHeight: 1.7, marginBottom: 32 }}>
            Learn from Kajol J Kamble — professional artist &amp; passionate teacher.
            Live Zoom classes + recorded YouTube sessions.
          </p>
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href={ENROLL_URL} style={{
              padding: '14px 28px', borderRadius: 14, fontWeight: 800, fontSize: 15,
              background: '#fff', color: C.pink, textDecoration: 'none',
      ...
      <div style={{ background: `linear-gradient(90deg, ${C.pinkD}, ${C.green})`, padding: '24px 16px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 16 }}>
          <Stat value="200+" label="Students Trained" color="#fff" />
          <Stat value="3"    label="Expert Courses"   color="#fff" />
          <Stat value="50+"  label="Classes Delivered" color="#fff" />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32, alignItems: 'center' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{
              ...
              background: `linear-gradient(135deg, ${C.pink}, ${C.pinkD})`,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 72, boxShadow: `0 12px 36px ${C.pink}44`,
              border: `6px solid ${C.pinkPale}`,
            }}>💄</div>
            <div style={{ fontSize: 18, fontWeight: 900, color: C.dark }}>Kajol J Kamble</div>
            <div style={{ fontSize: 13, color: C.grey, marginTop: 4 }}>Mehndi · Makeup · ArtWork Artist</div>
            {/* Social links */}
          ...
          <div>
            ...
            <h2 style={{ fontSize: 24, fontWeight: 900, color: C.dark, lineHeight: 1.3, marginBottom: 14 }}>
              Passionate Artist.<br />Dedicated Teacher.
            </h2>
            <p style={{ fontSize: 14, color: C.grey, lineHeight: 1.8, marginBottom: 12 }}>
              Hi! I'm Kajol, a professional Mehndi, Makeup, and ArtWork artist with years of experience
              working with brides, events, and art enthusiasts across India. My mission is to help
              you discover your creative potential — from home, at your own pace.
            </p>
            <p style={{ fontSize: 14, color: C.grey, lineHeight: 1.8, marginBottom: 20 }}>
              All my courses are conducted live on Zoom with recordings uploaded to YouTube,
              so you never miss a session. Whether you're a complete beginner or looking to
              polish your skills, there's a course for you here.
            </p>
            <a href={ENROLL_URL} style={{
      ...
      <Section id="courses" bg={C.greyL}>
        <SectionTitle emoji="📚" title="Our Courses"
          subtitle="Professional-level training from the comfort of your home. Live Zoom + YouTube recordings." />
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 18 }}>
          <CourseCard
            emoji="🌿" title="Mehndi Art" color={C.green}
            desc="From traditional bridal designs to modern Arabic patterns — learn step by step with daily practice sheets."
            items={['Basic & advanced patterns', 'Bridal & Arabic designs', 'Cone making & filling', 'Practice sheets included', 'Certificate on completion']}
          />
          <CourseCard
            emoji="💄" title="Makeup Course" color={C.pink}
            desc="Everyday glam to bridal looks — master professional makeup techniques used by top artists."
            items={['Skin prep & base makeup', 'Eye makeup & contouring', 'Bridal & party looks', 'Airbrush introduction', 'Kit guidance & product tips']}
          />
          <CourseCard
            emoji="🎨" title="ArtWork Course" color="#6A1B9A"
            desc="Unleash your creativity with canvas painting, mandala art, resin, and decorative crafts."
            items={['Mandala & dot art', 'Canvas painting', 'Resin art basics', 'Warli & folk art', 'DIY home décor projects']}
          />
          <CourseCard
            emoji="✨" title="Combined Course" color={C.amber}
            desc="Get the best of all three courses at a special bundled fee. Perfect for aspiring freelancers."
            items={['Mehndi + Makeup + ArtWork', 'Flexible batch timings', 'Special bundle pricing', 'Priority support from Kajol Ma\'am', 'Freelance career guidance']}
          />
        </div>
      </Section>
      ...
      {/* ── GALLERY (emoji art grid) ── */}
      <Section id="gallery" bg={C.pinkPale}>
        <SectionTitle emoji="🖼️" title="Our Work"
          subtitle="A glimpse of the beautiful art our students create!" />
        ...
        <p style={{ textAlign: 'center', fontSize: 13, color: C.grey, marginTop: 20 }}>
          Follow us on <a href={INSTAGRAM} target="_blank" rel="noopener noreferrer" style={{ color: C.ig, fontWeight: 700 }}>Instagram</a> &amp; <a href={YOUTUBE} target="_blank" rel="noopener noreferrer" style={{ color: C.yt, fontWeight: 700 }}>YouTube</a> for real student work!
        </p>
      </Section>
      ...
      <Section id="reviews">
        <SectionTitle emoji="⭐" title="What Students Say"
          subtitle="Real words from real learners who transformed their skills with us." />
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 18 }}>
          <TestimonialCard
            name="Priya Sharma" role="Homemaker · Mehndi Student"
            initial="P" color={C.pink}
          ...
          />
          <TestimonialCard
            name="Sneha Patil" role="Working Professional · Makeup Student"
            initial="S" color={C.green}
          ...
          />
          <TestimonialCard
            name="Ritika Nair" role="College Student · ArtWork Student"
            initial="R" color="#6A1B9A"
          ...
          />
          <TestimonialCard
            name="Aarti Kulkarni" role="Salon Owner · Combined Course"
            initial="A" color={C.amber}
      ...
      <Section bg={`linear-gradient(135deg, ${C.green}, #1B5E20)`} style={{ padding: '56px 16px' }}>
        ...
        <p style={{ textAlign: 'center', fontSize: 14, color: 'rgba(255,255,255,0.85)', lineHeight: 1.8, marginBottom: 28, maxWidth: 500, margin: '0 auto 28px' }}>
          Connect with 200+ students on WhatsApp, get daily tips, and stay updated on new batches.
        </p>
      ...
      <Section id="contact" bg={C.offWhite}>
        <div style={{ background: `linear-gradient(135deg, ${C.pink}, ${C.pinkD})`, borderRadius: 24, padding: '44px 24px', textAlign: 'center', boxShadow: `0 16px 48px ${C.pink}44` }}>
          ...
          <h2 style={{ fontSize: 26, fontWeight: 900, color: '#fff', marginBottom: 12 }}>Ready to Start Your Journey?</h2>
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.88)', lineHeight: 1.8, marginBottom: 28, maxWidth: 440, margin: '0 auto 28px' }}>
            Fill our free enrollment form today and get a personal reply from Kajol Ma'am on WhatsApp within 24 hours.
          </p>
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href={ENROLL_URL} style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 28, marginBottom: 28 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 12, opacity: 0.7, lineHeight: 1.8 }}>
                Professional Mehndi, Makeup &amp; ArtWork courses taught live online by Kajol J Kamble.
              </p>
            </div>
            {/* Quick links */}
            <div>
              ...
              {[
                ...
                <a key={l.label} href={l.href} style={{ display: 'block', fontSize: 13, opacity: 0.75, textDecoration: 'none', color: '#fff', marginBottom: 6, lineHeight: 1.6 }}>
                  → {l.label}
                </a>
              ))}
            </div>
